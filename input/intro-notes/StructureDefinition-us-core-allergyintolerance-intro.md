...
1. an estimate of the potential clinical harm of the reaction (e.g., low, high, or unable-to-assess)
...
{% include structure-table-block.md file_name="StructureDefinition-us-core-allergyintolerance" %}
