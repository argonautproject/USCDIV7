...
<!-- Build QA convention now lives in the parent ../CLAUDE.md, shared across the FHIR IG repos. -->
...
<!-- Authoring conventions: see parent ../CLAUDE.md. -->
...
<!-- House style for prose: see parent ../CLAUDE.md. -->
